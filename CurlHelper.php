...
class CurlHelper
{
     ...
     * сформирует другой заголовок по отправляемому типу данных: "Content-Type: multipart/form-data; boundary...".
     *
     ...
     * проверка для защиты от неё, хотя сам CURL разрешает такое значение).
     *
